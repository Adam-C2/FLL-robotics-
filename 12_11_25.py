...
#========
    ...
    move_cm(-50, 8)
    wait(0.75)
    await front_arm_movement(-25, 1000)
    move_cm(25, 2)
    await front_arm_movement(60, 1000)
    move_cm(100,30)
    turn(100, -100, 90)
    move_cm(100,100)
...
# Task 12_1
#========
    await front_arm_movement(104,250)
    move_cm(67,41)
    move_cm(-67, 2)
    await front_arm_movement(-104, 250)
    move_cm(-67,40)
...
#========
    ...
    turn(0,75, 89)
    move_cm(100, 6)
    await front_arm_movement(-44, 500)
    turn(75, 0, 85)
    move_cm(100,1)
    await front_arm_movement(70, 500)
    move_cm(-100, 1)
    await front_arm_movement(-35, 500)
#========
    
#========
# Task 10
#========
    await front_arm_movement(-20, 1000)
    turn(0, 75, 81)
    move_cm(100, 3.5)
    wait(1)
    turn(100, 0, 82)
    move_cm(75, 1)
    await front_arm_movement(40, 1000)
    await front_arm_movement(-40, 500)
    move_cm(-80, 10)
    turn(100, 0, 15)
    move_cm(80, 11)
    wait(0.5)
...
#========
    ...
    turn(100,-100,87)
    move_cm(-50,10)
    await front_arm_movement(50, 500)
    wait(3)
    await front_arm_movement(-50, 500)
    move_cm(50,10)
    turn(-100,100,90)
...
async def run_10():
    ...
    move_cm(-50, 3)
    turn(100,0,90)
    await front_arm_movement(120, 500)
    move_cm(-50,14)
    await side_arm_movement(-20,1000)
    await side_arm_movement(20,1000)
...
async def run_11():
    ...
    wait(0.5)
    turn(100,0,94)
    await side_arm_movement(90,1000)
    move_cm(-50,11.7)
    await side_arm_movement(-100,1000)
    await side_arm_movement(-100,1000)
    await side_arm_movement(110,1000)
    await side_arm_movement(-110,1000)
    await side_arm_movement(110,1000)
    await side_arm_movement(-110,1000)
    await side_arm_movement(110,1000)
